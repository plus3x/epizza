  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pizza as @pizza" do
        ...
        allow_any_instance_of(Pizza).to receive(:save).and_return(false)
        post :create, {:pizza => { "type" => "invalid value" }}, valid_session
        expect(assigns(:pizza)).to be_a_new(Pizza)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pizza" do
        ...
        expect_any_instance_of(Pizza).to receive(:update).with({ "type" => "" })
        put :update, {:id => pizza.to_param, :pizza => { "type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pizza as @pizza" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Pizza).to receive(:save).and_return(false)
        put :update, {:id => pizza.to_param, :pizza => { "type" => "invalid value" }}, valid_session
        expect(assigns(:pizza)).to eq(pizza)
      end
